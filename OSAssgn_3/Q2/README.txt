...
1. socket: sudo touch socket --> chmod 777 socket --> make
   fifo: make fifo
   message queue: make msg
2. for fifo: open split terminal and run ./p1fifo in 1 terminal and ./p2fifo in another terminal.
3. for message queue: open split terminal and first run ./p2msg in 1 terminal and then ./p2msg in another terminal. if the order is changed, the program will not work properly.
4. for unix domain socket: open split terminal first run ./p2socket in 1 terminal and then ./p2socket in another terminal. if the order is changed, the program will not work properly.
