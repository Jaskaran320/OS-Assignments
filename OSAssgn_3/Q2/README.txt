...
1. unix domain socket: make
   fifo: make fifo
   message queue: make msg
2. for unix domain socket: open split terminal and first run ./p2socket in 1 terminal and then ./p1socket in another terminal. If the order is changed, the program will not work properly.
